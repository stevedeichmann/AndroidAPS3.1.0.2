...
// other fields found in examples but not in documentation
    @SerializedName("NSCLIENT_ID") val NSCLIENT_ID: String?,                     // string ex: "1616391934628",
    ...
    @SerializedName("timeshift") val timeshift: Int,                    // integer "Profile Switch"
